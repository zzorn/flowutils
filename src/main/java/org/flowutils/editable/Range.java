...
import org.flowutils.interpolator.ValueInterpolator;
...
public interface Range<T> extends ValueInterpolator<T> {
     ...
     * @param valueOut for mutable types, this value should be changed.
     */
    T randomValue(T valueOut, RandomSequence randomSequence);
