...
public final class StreamUtils {
     ...
     * @throws java.io.IOException thrown if there was some problem reading the input stream
     */
     ...
     * @throws java.io.IOException thrown if there was problem reading the data, or if there was some error in the data,
     ...
     * @throws java.io.IOException thrown if there was problem writing the data.
     */
     ...
     * @throws java.io.IOException thrown if there was some error when reading the integer, or if the stream ended.
     */
     ...
     * @throws java.io.IOException thrown if there was some error when writing the integer.
     */
